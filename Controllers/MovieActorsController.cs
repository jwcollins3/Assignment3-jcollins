...
namespace Assignment3_jcollins.Controllers
{
    public class MovieActorsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["MovieTitle"] = new SelectList(_context.Movie, "MovieId", "MovieTitle");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ActorId,MovieId")] MovieActor movieActor)
        {
            ...
            ViewData["MovieId"] = new SelectList(_context.Movie, "MovieId", "MovieId", movieActor.MovieId);
            return View(movieActor);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["ActorId"] = new SelectList(_context.Actor, "ActorId", "ActorName", movieActor.ActorId);
            ViewData["MovieId"] = new SelectList(_context.Movie, "MovieId", "MovieTitle", movieActor.MovieTitle);
            return View(movieActor);
        }
