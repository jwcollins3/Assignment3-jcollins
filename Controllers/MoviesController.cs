...
namespace Assignment3_jcollins.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            movieDetailVM.Tweets = new List<MovieTweet>();
            ...
            foreach (var tweetText in tweets)
            {
                ...
                movieDetailVM.Tweets.Add(tweet);
            }
        ...
        public async Task<IActionResult> Create([Bind("MovieId,MovieTitle,MovieUrl,MovieGenre,MovieYear,MoviePoster")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MovieId,MovieTitle,MovieUrl,MovieGenre,MovieYear,MoviePoster")] Movie movie)
        {
            if (id != movie.MovieId)
            {
                return NotFound();
